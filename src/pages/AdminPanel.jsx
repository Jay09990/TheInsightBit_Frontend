          ...
          <div>
            ...
            <Editor
              ...
              init={{
                ...
                toolbar:
                  "undo redo | bold italic underline | fontfamily fontsize | alignleft aligncenter alignright | bullist numlist | removeformat",
                font_family_formats:
                ...
                fontsize_formats: "8px 10px 12px 14px 16px 18px 24px 32px 48px",
